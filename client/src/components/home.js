    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="flex justify-center items-center h-screen">
        <div className="w-full md:w-1/2">
          {/* <div className="shadow-[0_20px_300px_rgba(0,0,0,1)] border-2 border-[rgb(200,255,200)]/40 p-2 mb-5 bg-[rgb(0,0,0)]/90 rounded-3xl"> */}
          <div className="shadow-[0_20px_300px_rgba(0,0,0,1)] border-[rgb(200,255,200)]/40 p-2 mb-5 bg-[rgb(22,22,22)] rounded-3xl">
            ...
            <div className="gap-y-4 flex flex-col items-center">
              <input 
                type="text" 
                className="w-[700px] rounded-3xl mb-2 mx-20 p-3 pl-6 border border-slate-400 shadow-sm bg-black font-mono text-slate-500 font-extrabold" 
                placeholder="Room ID"
                value={roomId}
              ...
              <input 
                type="text" 
                className="w-[700px] rounded-3xl mb-2 mx-20 p-3 pl-6 border border-slate-400 shadow-sm bg-[rgb(200,255,200)] font-mono text-slate-500 font-extrabold" 
